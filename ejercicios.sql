...
-- EJERCICIO 34
SELECT HIRE_DATE, ADD_MONTHS(TO_DATE(HIRE_DATE, 'DD/MM/YYYY'), 12)
FROM EMPLOYEES;

-- EJERCICIO 35
SELECT UPPER(LAST_NAME), LOWER(FIRST_NAME), NVL(DEPARTMENT_ID, 99)
FROM EMPLOYEES
WHERE SALARY > 7000;
...
-- EJERCICIO 39
SELECT LAST_NAME, LENGTH(LAST_NAME), SUBSTR(LAST_NAME, 1, 5)
FROM EMPLOYEES;
